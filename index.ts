...
function getUser(username: string, password: string, callback: (error: any, results: any) => void) {
...
http.createServer((req, res) => {
    ...
    if (pathname === '/login') {
        ...
        getUser(username as string, password as string, (err, user) => {
            if (err) {
...
const obj: any = 'This is a string';
